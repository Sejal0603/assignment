    ...
    return(
        ...
        <div className="box">
            <div className="content">
                <div className="main-heading" style={{color:"#fff"}}>ready to get started?</div>
                <div className="subtext" style={{color:"#fff"}}>Risus habitant leo egestas mauris diam eget morbi tempus vulputate.</div>
                <div className="button" style={{background:"#fff"}}>
                    <div className="button-text" style={{color:"#000", paddingRight:"3px"}}>download app</div>
                        <div className="apple-icon" style={{ fill: "000", width: "25.775px", height: "31.638px"}}>
